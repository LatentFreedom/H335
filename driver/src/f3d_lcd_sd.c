/********************************************************** 
* f3d_lcd_sd.c
* LCD initializers and functions for output on LCD screen
* Author: Nick Palumbo, Ethan Lawton, Kyle Nealy
...
void f3d_lcd_sd_interface_init(void) {
 /* vvvvvvvvvvv pin initialization for the LCD goes here vvvvvvvvvv*/
  ...
  GPIOB_InitStructure.GPIO_Pin = GPIO_Pin_9 | GPIO_Pin_10 | GPIO_Pin_11 | GPIO_Pin_12 | GPIO_Pin_8; // 8 is for SD
...
void f3d_lcd_fillScreen2(uint16_t color) { //single pixel print
  uint8_t x,y;
